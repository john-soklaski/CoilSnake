...
class EbTileArrangement(EqualityMixin):
    ...
    def from_image(self, image, tileset, palette, no_flip=False, is_animation=False):
        if palette.num_subpalettes == 1:
            self._from_image_with_single_subpalette(image, tileset, palette, no_flip, is_animation)
        else:
    ...
    def _from_image_with_single_subpalette(self, image, tileset, palette, no_flip=False, is_animation=False):
